...
label_4 = Label(window, text = " Half dipole length (in lambda): ", bg = "#FFFFAA", font = "Ariel")
lengt = StringVar()
...
label_5 = Label(window, text = "Radius of Dipole (in lambda): ", bg = "#FFFFAA", font = "Ariel")
raD = StringVar()
...
button_1 = Button(window, text = "Save", command = window.destroy )
...
plt.grid()
plt.title('Current Distribution over a lamda/2 dipole @ 2.4GHz')
plt.xlabel('Length (m)')
